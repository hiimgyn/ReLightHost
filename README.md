...
![Version](https://img.shields.io/badge/version-1.2.0-9b72cf?style=flat-square)
...
│   │   └── PitchShifterGui.tsx # Built-in pitch shifter UI (Voice Color Panel XY pad)
│   ├── stores/
...
```
### VB-Cable
If you wanna use output without VoiceMeeter or something like that, just install VB-Audio Cable and set it to Virtual Output for use output into Discord, Teams, Meet...
